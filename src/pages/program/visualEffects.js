      ...
      <ProgramLayout>
        <div>
          <div className={style.heroImg}>
            <img
              src="https://images.unsplash.com/photo-1502404679462-d669245fc482?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
          ...
          <p>
            ...
            learn to master visual techniques to bring ideas to life. You will
            develop skills in modelling, texturing and lighting, as well as in
            visual effects, compositing and digital cinematography. We employ a
            teaching process and course structure that requires content created
            in one course to be used to complete assignments in other courses.
            This “pipeline” process mirrors that of industry, allowing students
            to make a seamless transition into a real production environment.
          </p>

          <p>
            The program is designed by artists for experienced traditional
            artists and animators who want to either develop or transition their
            skill sets for employment in the 3D and visual effects industries.
            The faculty take their years of industry experience into the
            classroom, straight from the studio. Their collective experience and
            passion in the gaming, television and film industries is the driving
            force that ensures the program meets the current and future needs of
            the industry.
          </p>
