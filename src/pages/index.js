...
<Layout>
  ...
  <section  className={style.midcardText}>
    <div className="card-deck text-center">
      ...
      <div className="card border-0 shadow mb-5 bg-white rounded" >
        <img src={graphicSvg} className="card-img-top" alt="graphicSvg"/>
        <div className="card-body p-3">
          <h5 className="card-title">Graphic Design</h5>
          <p className="card-text">Motivated. Creative. Innovator. If these words describe you, then our intensive Graphic Design for Print & Web certificate program is for you.</p>
        </div>
        <div class="card-footer text-muted">
          <Link to="/program" className={style.midcardText}>More</Link> 
        </div>
      </div>
      ...
      <p className="card-text">If you describe yourself as creative, resourceful, detail-oriented and a problem solver, then Humber's Web Design and Development certificate program is for you.</p>
      ...
      <p className="card-text">Humber's 3D Modelling and Visual Effects Production certificate program focuses on both the conceptual and the technical, as you learn to master visual techniques to bring ideas to life.</p>
      <p className="card-text">More</p> 
      </div>
      </Link>
      </div>
